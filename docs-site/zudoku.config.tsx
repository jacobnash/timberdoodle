  ...
  navigation: [
    {
      ...
      label: "Documentation",
      icon: "book",
      items: ["/introduction", "/architecture", "/multi-site", "/gateway-auth", "/fault-detection", "/webhooks", "/validate", "/haxall-drop-in", "/haystack-puller", "/adding-a-data-source", "/weather-stations"],
    },
    {
      type: "category",
      label: "API Reference",
